...
def is_valid():
    ...
    if is_valid:
        ...
        response = {'message': '47 we have a problem. Blockchain is not valide'}
    return jsonify(response), 200
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'The nodes had different chains so chain got replaced by the longest chain',
                    'new_chain': blockchain.chain}
    else:
        response = {'message': 'All good the chain is longest one',
